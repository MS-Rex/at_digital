  ...
  return (
    <div className="grid">
      <nav className="bg-primary flex h-16 py-5 px-5 justify-between">
        <img src={Logo} alt="Company Logo " className="md:ml-5" />
        ...
        {isMenuOpen && (
          <div className="absolute right-0 mt-12  mr-1 py-2 w-48 bg-[#6a44f2] rounded-lg shadow-xl z-20">
        ...
        <div className="hidden md:block mb-2 sm:mb-0">
          <a href="#" className="mr-7 text-sm text-white hover:text-gray-300">
            SERVICES
          </a>
          <a href="#" className="mr-7 text-sm text-white hover:text-gray-300">
            ABOUT US
